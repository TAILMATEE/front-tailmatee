    ...
    return (
        <form className='justify-items-center'>
            <GeneralInput
                ...
                isClearable
                startContent={
                    <img src={UserName} alt="UserName" className="text-2xl text-default-400 pointer-events-none flex-shrink-0" />
                }
            />
            <GeneralInput
                type="email"
            ...
            <GeneralInput
                ...
                isClearable
                startContent={
                    <img src={Cell} alt="UserName" className="text-2xl text-default-400 pointer-events-none flex-shrink-0" />
                }
            />
            <InputDate/>
            <GeneralInput
